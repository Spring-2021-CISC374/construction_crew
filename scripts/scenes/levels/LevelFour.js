class LevelFour extends Phaser.Scene {
  constructor() {
    ...
    create() {
      ...
      this.add.text(config.width/3, 50, "Welcome to Level Four!", {
        font: "60px Arial",
        fill: "black",
        align: "center"
      });
    ...
    updateToCalendar() {
      ...
      this.scene.start("Calendar", {contractor: ["Concrete", "Framer", "Plumber", "Roofer", "Electrician", "Painter"], blocked: [2], level: 4, rows: 2});
    }
  }
